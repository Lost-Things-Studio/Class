...
When an incident does occur, report it promptly by contacting the maintainers at
[gopmyc.pro@gmail.com](mailto:gopmyc.pro@gmail.com). If you prefer not to use
email, you may open a GitHub issue and ask for a private maintainer contact, but
do not include sensitive details in a public issue.

Please include as much context as you safely can:

- Your preferred contact method.
- What happened and when.
- Where it happened, such as an issue, pull request, discussion, or another
  community space.
- Links, screenshots, logs, or other supporting information when appropriate.
- Whether there is an immediate safety concern.

Project maintainers act as Community Moderators for this project. They take
reports of violations seriously and will make every reasonable effort to respond
in a timely manner. They may review messages, logs, or other relevant materials,
and may speak with people involved in or affected by the incident.

Community Moderators will keep investigation and enforcement actions as
transparent as possible while prioritizing safety, privacy, and confidentiality.
Enforcement actions are usually handled privately with the involved parties, but
maintainers may share a public update when doing so is necessary for community
safety or clarity.
